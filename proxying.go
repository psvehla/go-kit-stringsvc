...
func proxyingMiddleware(ctx context.Context, instances string, logger log.Logger) ServiceMiddleware {
	...
	// Otherwise, construct an endpoint for each instance in the list and add it to a fixed set of endpoints. In a real service, rather than doing
	// this by hand, you'd probably use package sd's support for your serivce discovery system.
	var (
